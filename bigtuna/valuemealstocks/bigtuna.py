...
with open("bigtuna.csv", "w") as file:
...
with open('AAA.csv', newline='') as csvfile:
    ...
    bond_yield = float(data[2][0].split("%")[0])
csvfile.close()
...
with open('bigtuna.csv', newline='') as csvfile:
    data = [row for row in csv.reader(csvfile)]
    msft = (data[2][1])
    fb = (data[4][1])
    amzn = (data[6][1]).split(',')
...
msft_fiv = (float(data[2][13])) * 4.4 * (8.5 + 2 * (float(data[2][45].split('%')[0]))) / float(bond_yield)
msft_piv = (msft_fiv / ((1.15) ** 5))

fb_fiv = (float(data[4][13])) * 4.4 * (8.5 + 2 * (float(data[4][45].split('%')[0]))) / float(bond_yield)
fb_piv = (fb_fiv / ((1.15) ** 5))

amzn_fiv = (float(data[6][13])) * 4.4 * (8.5 + 2 * (float(data[6][45].split('%')[0]))) / float(bond_yield)
amzn_piv = (amzn_fiv / ((1.15) ** 5))

goog_fiv = (float(data[8][13])) * 4.4 * (8.5 + 2 * (float(data[8][45].split('%')[0]))) / float(bond_yield)
goog_piv = (goog_fiv / ((1.15) ** 5))

aapl_fiv = (float(data[10][13])) * 4.4 * (8.5 + 2 * (float(data[10][45].split('%')[0]))) / float(bond_yield)
...
msft_earnings = (avg * float(data[2][13])) #MSFT earnings price

fb_earnings = (avg * float(data[4][13])) #FB earnings price

amzn_earnings = (avg * float(data[6][13])) #AMZN earnings

goog_earnings = (avg * float(data[8][13])) #GOOG earnings

aapl_earnings = (avg * float(data[10][13])) #AAPL earnings price
...
msft_sales = ((float(data[2][48].split('B')[0]) * 1000000000 * float(data[2][98])) / ((float(data[2][63].split('B')[0]) * 1000000000)))

fb_sales = ((float(data[4][48].split('B')[0]) * 1000000000 * float(data[4][98])) / ((float(data[4][63].split('B')[0]) * 1000000000)))

amzn_sales = ((float(data[6][48].split('B')[0]) * 1000000000 * float(data[6][98])) / ((float(data[6][63].split('M')[0]) * 1000000)))

goog_sales = ((float(data[8][48].split('B')[0]) * 1000000000 * float(data[8][98])) / ((float(data[8][63].split('M')[0]) * 1000000)))

aapl_sales = ((float(data[10][48].split('B')[0]) * 1000000000 * float(data[10][98])) / ((float(data[10][63].split('B')[0]) * 1000000000)))
...
msft_book = float("{:.2f}".format((float(data[2][62]) * float(data[2][100]))))
fb_book = float("{:.2f}".format((float(data[4][62]) * float(data[4][100]))))
amzn_book = float("{:.2f}".format((float(data[6][62]) * float(data[6][100]))))
goog_book = float("{:.2f}".format((float(data[8][62]) * float(data[8][100]))))
aapl_book = float("{:.2f}".format((float(data[10][62]) * float(data[10][100]))))
...
#EV/EBITDA
msft_ebitda = float(data[2][51].split('T')[0]) * 1000 / float(data[2][58].split('B')[0])
fb_ebitda = float(data[4][51].split('B')[0]) / float(data[4][58].split('B')[0])
amzn_ebitda = float(data[6][51].split('T')[0]) * 1000 / float(data[6][58].split('B')[0])
goog_ebitda = float(data[8][51].split('B')[0]) / float(data[8][58].split('B')[0])
aapl_ebitda = float(data[10][51].split('T')[0]) * 1000 / float(data[10][58].split('B')[0])
...
msft_ev = "{:.2f}".format((float(data[2][58].split('B')[0]) * avg / ((float(data[2][63].split('B')[0])))))
msft_ev = float(msft_ev)

fb_ev = "{:.2f}".format((float(data[4][58].split('B')[0]) * avg / ((float(data[4][63].split('B')[0])))))
fb_ev = float(fb_ev)

amzn_ev = "{:.2f}".format((float(data[6][58].split('B')[0]) * avg * 1000 / ((float(data[6][63].split('M')[0])))))
amzn_ev = float(amzn_ev)

goog_ev = "{:.2f}".format((float(data[8][58].split('B')[0]) * avg * 1000  / ((float(data[8][63].split('M')[0])))))
goog_ev = float(goog_ev)

aapl_ev = "{:.2f}".format((float(data[10][58].split('B')[0]) * avg / ((float(data[10][63].split('B')[0])))))
...
msft_cashflow = float(msft) / ((float(data[2][101]) / float(data[2][102])))
msft_cashflow = ("{:.2f}".format(msft_cashflow))

fb_cashflow = float(fb) / ((float(data[4][101]) / float(data[4][102])))
fb_cashflow = ("{:.2f}".format(fb_cashflow))

amzn_cashflow = float(amzn) / ((float(data[6][101]) / float(data[6][102])))
amzn_cashflow = ("{:.2f}".format(amzn_cashflow))

goog_cashflow = float(goog) / ((float(data[8][101]) / float(data[8][102])))
goog_cashflow = ("{:.2f}".format(goog_cashflow))

aapl_cashflow = float(aapl) / ((float(data[10][101]) / float(data[10][102])))
